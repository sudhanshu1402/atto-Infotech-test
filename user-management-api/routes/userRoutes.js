 ...
 */
router.get('/:id', authenticateToken, authorizeRole(['admin', 'user']), userController.getUserById);
 ...
 */
router.post('/upload', authenticateToken, authorizeRole(['admin']), upload.single('file'), userController.uploadUsersFromCSV);
